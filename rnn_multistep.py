...
#
# # show the difference
# plt.plot(abs(inv_yhat[0:256, 0]-inv_y[0:256, 0]), label='T1_difference')
# plt.plot(abs(inv_yhat[0:256, 1]-inv_y[0:256, 1]), label='T2_difference')
# plt.plot(abs(inv_yhat[0:256, 2]-inv_y[0:256, 2]), label='T3_difference')
# # plt.plot(inv_y[0:256, 0], label='ground_truth')
#
