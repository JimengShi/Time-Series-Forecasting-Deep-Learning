...
# show the difference
plt.plot(np.subtract(inv_yhat[25:384, 0], inv_y[20:379, 0]), label='T1_difference')     # truth_y[10:369]
plt.plot(np.subtract(inv_yhat[25:384, 1], inv_y[20:379, 0]), label='T2_difference')
plt.plot(np.subtract(inv_yhat[25:384, 2], inv_y[20:379, 0]), label='T3_difference')
